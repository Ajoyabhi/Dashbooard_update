...
import { Plus, Key, Globe, Edit, Filter, X, Search } from 'lucide-react';
...
export default function ManageStaff() {
  ...
  const filteredStaff = mockStaff.filter(staff => {
    const matchesName = staff.name.toLowerCase().includes(filterValues.name.toLowerCase());
    const matchesStatus = filterValues.status === 'all' || staff.status === filterValues.status;
