    ...
    <div className="space-y-6 animate-fade-in max-w-4xl">
      ...
      <Section title="Authentication">
        <p className="text-sm text-slate-600">
          ...
          <Link to="/agent/developer-settings" className="text-[#1A2744] font-semibold underline underline-offset-2">Developer Settings</Link>.
        </p>
      ...
      <Section title="Notes & Requirements">
        <ul className="space-y-2 text-sm text-slate-600">
          {[
            ...
            <>Get your JWT token from <Link to="/agent/developer-settings" className="text-[#1A2744] font-semibold underline underline-offset-2">Developer Settings</Link>.</>,
          ].map((item, i) => (
